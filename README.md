...
Precis som vid implementationen av lasern bygger monstrets rörelse på metodanrop i en egen tråd i Main-klassen - monstrets hastighet sätts på samma sätt. Se variabeln "Monsterspeed" nedan.
